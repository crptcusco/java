 ...
 * @author carlo
 */
public class JFN2Juego2 extends javax.swing.JFrame {
    Vector data = null;
    /**
     * Creates new form JFN2Juego2
     */
    public JFN2Juego2(Vector data) {
       initComponents();
        this.data= data;
        data.set(data.size()-1,3);
        this.lblIntento.setText(((Juego)data.get(3)).getIntento() + "");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFN2Juego2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFN2Juego2(null).setVisible(true);
            }
        });
    }
