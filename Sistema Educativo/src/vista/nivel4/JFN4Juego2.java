 ...
 * @author carlo
 */
public class JFN4Juego2 extends javax.swing.JFrame {
Vector data = null;
    /**
     * Creates new form JFN4Juego2
     */
    public JFN4Juego2(Vector data) {
          initComponents();
        this.data= data;
        data.set(data.size()-1,7);
        this.lblIntento.setText(((Juego)data.get(7)).getIntento() + "");
    }
    ...
    private void initComponents() {
        ...
        setTitle("Nivel 4 - Juego 2");

        btnRevisar1.setText("Revisar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFN4Juego2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFN4Juego2(null).setVisible(true);
            }
        });
    }
