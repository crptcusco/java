 ...
 * @author carlo
 */
public class JFN4Juego1 extends javax.swing.JFrame {
    Vector data = null;
    /**
     * Creates new form JFN4Juego1
     */
    public JFN4Juego1(Vector data) {
        initComponents();
        this.data= data;
        data.set(data.size()-1,6);
        this.lblIntento.setText(((Juego)data.get(6)).getIntento() + "");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFN4Juego1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFN4Juego1(null).setVisible(true);
            }
        });
    }
