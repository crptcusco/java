 ...
 * @author carlo
 */
public class JFN3Juego1 extends javax.swing.JFrame {
    Vector data = null;
    /**
     * Creates new form JFN3Juego1
     */
    public JFN3Juego1(Vector data) {
        initComponents();
        this.data= data;
        data.set(data.size()-1,4);
        this.lblIntento.setText(((Juego)data.get(4)).getIntento() + "");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFN3Juego1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFN3Juego1(null).setVisible(true);
            }
        });
    }
