 ...
 * @author carlo
 */
public class JFN3Juego2 extends javax.swing.JFrame {
    Vector data = null;
    /**
     * Creates new form JFN3Juego2
     */
    public JFN3Juego2(Vector data) {
      initComponents();
        this.data= data;
        data.set(data.size()-1,5);
        this.lblIntento.setText(((Juego)data.get(5)).getIntento() + "");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFN3Juego2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFN3Juego2(null).setVisible(true);
            }
        });
    }
