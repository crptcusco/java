...
import vista.JFResultados;

/**
 *
 * @author carlo
 */
public class JFN1Juego1 extends javax.swing.JFrame {
    Vector data = null;
    /**
     * Creates new form JFN1Juego1
     */
    public JFN1Juego1(Vector data) {
        initComponents();
        this.data= data;
        data.set(data.size()-1,0);
        this.lblIntento.setText(((Juego)data.get(0)).getIntento() + "");
    }
    ...
    private void initComponents() {
        ...
        setTitle("Nivel 1 - Juego 1");

        lblPuntaje.setText("4");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFN1Juego1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFN1Juego1(null).setVisible(true);
            }
        });
    }
