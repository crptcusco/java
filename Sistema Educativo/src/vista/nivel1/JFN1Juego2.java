 ...
 * @author carlo
 */
public class JFN1Juego2 extends javax.swing.JFrame {

    Vector data = null;

    /**
     * Creates new form JFN1Juego2
     */
    public JFN1Juego2(Vector data) {
        initComponents();
        this.data= data;
        data.set(data.size()-1,1);
        this.lblIntento.setText(((Juego)data.get(1)).getIntento() + "");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFN1Juego2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFN1Juego2(null).setVisible(true);
            }
        });
    }
